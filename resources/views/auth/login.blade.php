        ...
        <div class="container">
            <div class="first-section">
                ...
                @else
                    ...
                    <p class="text-subtitle text-center pb-4 d-flex flex-column flex-md-row align-items-center justify-center">
                        Non hai un account? <a href="{{ route('register') }}"
                            class="btn-mokador ms-0 mt-2 mt-md-0 ms-md-3">Registrati</a></p>
                @endif
            </div>
        </div>
    </section>
