<div style="display: flex; justify-content: center; align-items: center; overflow: hidden; max-height: 88vh;">
    @if ($record->receipt_image)
        <img
            ...
            style="max-height: 88vh; max-width: 100%; width: auto; height: auto; object-fit: contain; display: block;"
        >
    @else
