        ...
        <div class="container pb-5">
            <div class="first-section">
                ...
                @else
                    ...
                    <p class="small-caption text-center mt-3">Si prega di fotografare lo scontrino nella sua interezza, senza nascondere il nome del punto vendita e la data.</p>
                @endif
            </div>
        </div>
    </section>
