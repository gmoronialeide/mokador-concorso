    ...
    <section>
        <div class="teaser">
            ...
            <div class="teaser-home-content">
                ...
                <img class="teaser-home-logo" src="{{ asset('img/mokador-concorso-logo.svg') }}"
                    alt="Mokador Concorso Logo">
            </div>
        </div>
    </section>
    ...
    <section class="section-dark">
        <div class="container position-relative">
            ...
            <div class="d-flex justify-content-center align-items-center flex-column py-5 gap-4">
                ...
                <p class="text-light text-center text-subtitle">Ogni giorno <strong>tenta la fortuna</strong>:<br>scopri
                    subito se hai vinto!</p>
        ...
        <div class="container z-2 position-relative">
            ...
            <div class="prize-container">
                ...
                <div class="d-flex flex-column gap-3 align-items-center justify-content-center order-1 order-lg-2">
                    ...
                    <p class="text-subtitle text-center">Il primo premio è <strong>una settimana per 2 persone</strong>
                        presso il <a href="https://www.familyhotelgranbaita.it/" target="_blank" rel="noopener">Family Hotel
                            Gran Baita</a>, immerso nella splendida Val di Fassa, esplora e rilassati tra i paesaggi
                        suggestivi delle Dolomiti.</p>
                    <p class="text-subtitle text-center">Il soggiorno è valido esclusivamente dall'11 al 18 luglio 2026. Il
                        vincitore dovrà confermare la propria presenza direttamente all'hotel entro il 30 giugno 2026.</p>
                    <p class="text-subtitle text-center"><strong>Non sono incluse le spese di viaggio e i servizi non
                            espressamente ricompresi</strong></p>
                </div>
            </div>
        </div>
        ...
        <div class="container z-2 position-relative">
            <div class="prize-container gap-4">
                <div class="d-flex flex-column gap-3 align-items-center justify-content-center">
                    ...
                    <p class="text-subtitle text-center">Il secondo premio è la <strong>macchina caffè Diva E1 di Mokador,
                            compatta ed elegante</strong>, perfetta per un espresso cremoso come al bar.</p>
                    <p class="text-subtitle text-center">In regalo anche <strong>100 capsule di caffè</strong> per iniziare
                        subito a gustarla.</p>
                </div>
        ...
        <div class="container z-2 position-relative">
            <div class="prize-container gap-4">
                ...
                <div class="d-flex flex-column gap-3 align-items-center justify-content-center order-1 order-lg-2">
                    ...
                    <p class="text-subtitle text-center">Il terzo premio è un pratico <strong>montalatte</strong>, perfetto
                        per preparare a casa cappuccini cremosi e soffici schiume di latte come al bar.</p>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container py-5">
            <div class="d-flex flex-column gap-4 align-items-center justify-content-center py-5">
                ...
                <p class="text-subtitle text-center">Gioca subito, hai una <strong>opportunità giornaliera</strong> per
                    vincere <strong>fantastici premi</strong><br>e alla fine parteciperai all'<strong>estrazione
                        finale</strong>!</p>
                <a href="{{ auth()->check() ? route('game.show') : route('register') }}" class="btn-mokador">Registrati e
                    Vinci</a>
            </div>
        </div>
    </section>
